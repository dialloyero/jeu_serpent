window.onload = function() {
    ...
    function gameOver()
    {
        ...
        ctx.strokeText("Jeu Terminé",centreX, centreY -180);
        ctx.fillText("Jeu Terminé", centreX, centreY -180);
    ...
    function Snake(body, direction)
    {
        ...
        this.checkCollision = function()
        {
            ...
            var isNotBetwennHorizontalWalls = snakeX < minX || snakeX > maxX; 
            var isNotBetwennVerticalWalls = snakeY < minY || snakeY > maxY;
            
            if(isNotBetwennHorizontalWalls || isNotBetwennVerticalWalls)
            {
                wallCollision = true;
            }
